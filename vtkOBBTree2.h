...
=========================================================================*/
// .NAME vtkOBBTree2 - generate oriented bounding box (OBB) tree
// .SECTION Description
// vtkOBBTree2 is an object to generate oriented bounding box (OBB) trees.
...
#ifndef __vtkOBBTree2_h
#define __vtkOBBTree2_h
...
class VTK_GRAPHICS_EXPORT vtkOBBTree2 : public vtkAbstractCellLocator
{
public:
  vtkTypeMacro(vtkOBBTree2,vtkAbstractCellLocator);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct with automatic computation of divisions, averaging
  // 25 cells per octant.
  static vtkOBBTree2 *New();
...
//ETX
  ...
  int IntersectWithOBBTree( vtkOBBTree2 *OBBTreeB, vtkMatrix4x4 *XformBtoA,
...
protected:
  ...
  //ETX
private:
  vtkOBBTree2(const vtkOBBTree2&);  // Not implemented.
  void operator=(const vtkOBBTree2&);  // Not implemented.
};
